                                ...
                                <div className="relative bg-white rounded-xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <button className="p-4 rounded-xl border-2 border-slate-200 hover:border-green-400 hover:bg-green-50 transition-all duration-200 transform hover:scale-105 text-center">
                                            ...
                                            <div className="font-semibold text-slate-800">M-Pesa</div>
                                            <div className="text-xs text-slate-500 mt-1">Instant</div>
                                        </button>
                                        <button className="p-4 rounded-xl border-2 border-slate-200 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 transform hover:scale-105 text-center">
                                            <div className="text-2xl mb-2">🏦</div>
                                ...
                                <div className="relative bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100 shadow-sm hover:shadow-md transition-all duration-300">
                                    ...
                                    <div className="space-y-3 text-slate-700">
                                        ...
                                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-green-100">
                                            ...
                                            <span>Enter Paybill: <strong className="text-green-600">123456</strong></span>
                                        </div>
                                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-green-100">
                                            <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-sm font-bold">4</div>
                                            <span>Account: <strong className="text-green-600">JMNYAGA</strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
