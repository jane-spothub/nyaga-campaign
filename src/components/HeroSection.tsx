...
export default function HeroSection() {
    ...
    const missionSlides = [
        {
            id: 1,
            content: "Development-first leadership focused on better roads, reliable water, and real opportunities for Tharaka's youth.",
            emphasis: ["better roads", "reliable water", "real opportunities"]
        },
        {
            id: 2,
            content: "This campaign is about creating dignified work, restoring community pride, and delivering measurable progress.",
            emphasis: ["dignified work", "community pride", "measurable progress"]
        },
        {
            id: 3,
            content: "Transforming Tharaka through infrastructure development, youth empowerment, and sustainable economic growth.",
            emphasis: ["infrastructure development", "youth empowerment", "sustainable economic growth"]
        }
    ];
                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="max-w-6xl mx-auto w-full">
                        <div className="text-center space-y-6 sm:space-y-8">
                            ...
                            >
                                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-orange-400 to-red-400 rounded-full animate-pulse" />
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                >
                                    ...
                                    <span className="relative">
                                        ...
                                        <div className="absolute -bottom-1 sm:-bottom-2 left-0 w-full h-0.5 sm:h-1 bg-gradient-to-r from-orange-400 to-red-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                    </span>
                                    <br />
                                    <span className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-light text-blue-100">
                                        for Tharaka
                                    </span>
                                </motion.h1>
                            ...
                            <motion.div
                                ...
                                className="flex flex-row gap-3 sm:gap-4 justify-center items-center pt-3 sm:pt-3"
                            >
                                <Link
                                    href="/volunteer"
                                    className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl sm:rounded-2xl font-bold hover:from-blue-500 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg sm:shadow-xl hover:shadow-2xl min-w-[140px] sm:min-w-[160px] lg:min-w-[180px] xl:min-w-[200px] border border-blue-400/30 overflow-hidden text-sm sm:text-base"
                                >
                                ...
                                <Link
                                    href="/donate"
                                    className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl sm:rounded-2xl font-bold hover:from-orange-400 hover:to-red-400 transition-all duration-300 transform hover:scale-105 shadow-lg sm:shadow-xl hover:shadow-2xl min-w-[140px] sm:min-w-[160px] lg:min-w-[180px] xl:min-w-[200px] border border-orange-400/30 overflow-hidden text-sm sm:text-base"
                                >
                                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent transform -skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
